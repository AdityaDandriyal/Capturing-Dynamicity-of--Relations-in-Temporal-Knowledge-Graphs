...
class HyTE(Model):
	...
	def load_data(self):
		...
		with open(self.p.dataset,'r') as filein:
			for line in filein:
				...
				#creation of the triple time dictionary which are being used in the functions above.
	...
	def calculated_score_for_positive_elements(self, t, epoch, f_valid, eval_mode='valid'):
		...
		#t is a triple that stores entities and relation and also temporal info(4th element)
...
if __name__== "__main__":
	...
	args.dataset = '/home/adityad/HyTE/HyTE-master/data/'+ args.data_type +'/'+ args.version+'/train.txt'
	args.entity2id = '/home/adityad/HyTE/HyTE-master/data/'+ args.data_type +'/'+ args.version+'/entity2id.txt'
	args.relation2id = '/home/adityad/HyTE/HyTE-master/data/'+ args.data_type +'/'+ args.version+'/relation2id.txt'
	args.valid_data  =  '/home/adityad/HyTE/HyTE-master/data/'+ args.data_type +'/'+ args.version+'/valid.txt'
	args.test_data  =  '/home/adityad/HyTE/HyTE-master/data/'+ args.data_type +'/'+ args.version+'/test.txt'
	args.triple2id  =   '/home/adityad/HyTE/HyTE-master/data/'+ args.data_type +'/'+ args.version+'/triple2id.txt'
